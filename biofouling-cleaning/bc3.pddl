...
(:objects
    ...
    arm2 arm3 arm4
    cavity-c0 cavity-c1 - actuator
    c0 c1  c2 c3 c4
    cad2 cad3 cad4 - sensor
...
(:init
    ...
    (can_clean auv0 cavity-c0)
    (can_clean auv1 cavity-c1)

    (can_identify auv2 cad2)
    (can_identify auv3 cad3)
    (can_identify auv4 cad4)
    ...
    (is_surface_robot asv0)
    (is_surface_robot asv1)
    (is_surface_robot asv2)

    (is_underwater_robot auv0)
    (is_underwater_robot auv1)
    (is_underwater_robot auv2)
    (is_underwater_robot auv3)
    (is_underwater_robot auv4)

    (communication_point wp60)
    (communication_point wp70)
    (communication_point wp80)
    ...
    (= (inspect_area_dur) 20)
    (= (clean_biofouling_dur) 20)
    (= (sense_valve_dur) 5)
    (= (close-valve_dur) 5)
    (= (broadcast_data_dur) 5)
    (= (target_approach_dur) 1)
    (= (recover_robot_dur) 1)
